...
export const QUERY_KEYS = {
  ...
  GET_ALL_SCHEDULES_FOR_REFEREE: "GET_ALL_SCHEDULES_FOR_REFEREE",
  GET_ALL_SCHEDULES_BY_USER: "GET_ALL_SCHEDULES_BY_USER",
  GET_ALL_SCHEDULES_OF_REFEREE: "GET_ALL_SCHEDULES_OF_REFEREE",
};
